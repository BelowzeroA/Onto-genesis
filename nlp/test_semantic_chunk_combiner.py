...
def main():
    ...
    samples = ['чтобы [перейти дорогу] в России, [посмотрите направо]',
               ...
               '[Машинка для кофе] была сломана',
               'Небольшой [поворот тумблера] приводит к [значительному эффекту]',
    ...
    # test_sample = 'чтобы перейти дорогу в Англии, посмотрите налево'
    ...
    if train:
        ...
        combiner.train(samples, rand_seed=2, number_of_epochs=100)
